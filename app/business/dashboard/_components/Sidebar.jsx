...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      name: t?.sidebar?.investors ?? "Investors",
      path: "/business/dashboard/investors"
    },
    {
      icon: <FiSearch size={20} />,
      name: t?.sidebar?.browseInvestors ?? "Browse Investors",
      path: "/business/dashboard/investors/browse"
    },
  ];
